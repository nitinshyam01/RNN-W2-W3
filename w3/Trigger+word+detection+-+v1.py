...
def is_overlapping(segment_time, previous_segments):
    ...
    for previous_start, previous_end in previous_segments:
        if (segment_start<previous_start and segment_end>=previous_start)or (segment_end>previous_end and segment_start<=previous_end)or (segment_start>=previous_start and segment_end<=previous_end):
            overlap = True
    ### END CODE HERE ###
...
def model(input_shape):
    ...
    X = Conv1D(filters=196,kernel_size=15)(X_input)                                 # CONV1D
